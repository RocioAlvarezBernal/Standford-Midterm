...
//	Compute the value of each of the following Java expressions. If an error occurs during
//	any of these evaluations, write ―Error‖ on that line and explain briefly why the error
//	occurs.
//	5.0 / 4 - 4 / 5 ------- (2a) 5.0 / 4 - 4 / 5 1.25
//	7 < 9 - 5 && 3 % 0 == 3 ------ 7 < 9 - 5 && 3 % 0 == 3 false
//	"B" + 8 + 4     ------- "B" + 8 + 4 "B84"
//		
	import acm.program.*;
	public class SimpleJavaexpressionsstatementsmethods extends ConsoleProgram {
	public void run() {
	int num1 = 2;
	int num2 = 13;
